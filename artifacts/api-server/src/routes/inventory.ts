...
router.post("/inventory", requireEdit("our-life"), async (req, res) => {
  try {
...
router.patch("/inventory/:id", requireEdit("our-life"), async (req, res) => {
  try {
...
router.delete("/inventory/:id", requireEdit("our-life"), async (req, res) => {
  try {
