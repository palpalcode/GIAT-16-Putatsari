            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <button
                  ...
                  className="w-full flex items-center justify-between px-3 py-2 rounded-md border border-white/50 bg-white/50 text-sm focus:border-rose-300 focus:outline-none focus:ring-1 focus:ring-rose-300"
                >
